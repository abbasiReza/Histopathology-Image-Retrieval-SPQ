...
def get_args_parser():
    ...
    parser.add_argument('--batch_size', default=8, type=int, help="""Training mini-batch size.""")
...
def train_SPQ(args):
    ...
    class_name, train_img_list = get_data_list('D:\\original_images_5\\test-patches\\trainset\\SPQ\\final\\train\\final')
